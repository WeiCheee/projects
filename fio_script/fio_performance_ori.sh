...
time fio -output=/home/hsu/Desktop/fio_result/ -name=test -filename=/media/hsu/testRW/test -ioengine=libaio -size=63G -direct=1 -thread=1 -blocksize=4k -rw=write -iodepth=32 -numjobs=1
			...
			do 
				...
				do 
					...
					do 
						...
						time fio -output=/home/hsu/Desktop/fio_result/${blockarray[a]}_${rwarray[b]}_${dparray[c]}_${sizearray[d]}_${enginearray[e]}_${countarray[f]} -name=test -filename=/media/hsu/testRW/test -ioengine=${enginearray[e]} -size=${sizearray[d]} -direct=1 -thread=1  -blocksize=${blockarray[a]} -rw=${rwarray[b]} -iodepth=${dparray[c]} -numjobs=1 -runtime=60						
						sleep 10
